 ...
 * Play the sound.
 */
Sound.prototype.play = function( sender ) {
	this._gainNode = this._context.createGain();

	this._pannerNode = this._context.createPanner();
	this._pannerNode.setPosition( sender.x, sender.y, 0 );
	this._pannerNode.maxDistance = sender.hearableDistance;
	this._pannerNode.rolloffFactor = 0; // We calculate and set the volume ourselves.
